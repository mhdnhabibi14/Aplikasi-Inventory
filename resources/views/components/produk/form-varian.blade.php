                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_varian" id="nama_varian" class="form-control"
                                value="{{ old('nama_varian', $nama_varian ?? '') }}"></input>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="harga_varian" id="harga_varian" class="form-control"
                                value="{{ old('harga_varian', $harga_varian ?? '') }}"></input>
                            <small class="text-danger"></small>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="number" name="stok_varian" id="stok_varian" class="form-control"
                                value="{{ old('stok_varian', $stok_varian ?? '') }}"></input>
                            <small class="text-danger"></small>
                        </div>
                        <div class="form-group">
                            <label for="gambar_varian" class="form-label">Gambar Varian</label>
                            <input type="file" name="gambar_varian" id="gambar_varian" class="form-control"></input>
                            <small class="text-danger"></small>
                        </div>
                    </div>
