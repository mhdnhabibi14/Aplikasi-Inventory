...
{
    public string $pageTitle = "Input Laporan Stok Opname";
    public ?int $activePeriode = null;
    ...
    public function update(UpdateInputStokOpnameRequest $request, int $id)
    {
        ...
        $itemStokOpname = ItemStokOpname::where('periode_stok_opname_id', $this->activePeriode)->where('status', 'belum dilaporkan')->count();
        if ($itemStokOpname == 0) {
