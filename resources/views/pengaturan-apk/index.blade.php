    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-round">
                ...
                <form action="{{ route('pengaturan-apk.update', $pengaturan->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        {{-- Tanggal Analisa Awal --}}
                        <div class="form-group mb-4">

                            <label for="tanggal_analisa_awal" class="form-label">
                            ...
                            <input type="date" name="tanggal_analisa_awal" id="tanggal_analisa_awal"
                                ...
                                value="{{ old(
                                    ...
                                    isset($pengaturan->tanggal_analisa_awal) ? $pengaturan->tanggal_analisa_awal->format('Y-m-d') : '',
                                ) }}">
                        ...
                        {{-- Tanggal Analisa Akhir --}}
                        <div class="form-group mb-4">

                            <label for="tanggal_analisa_akhir" class="form-label">
                            ...
                            <input type="date" name="tanggal_analisa_akhir" id="tanggal_analisa_akhir"
                                ...
                                value="{{ old(
                                    ...
                                    isset($pengaturan->tanggal_analisa_akhir) ? $pengaturan->tanggal_analisa_akhir->format('Y-m-d') : '',
                                ) }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <label for="minimal_stok" class="form-label">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="minimal_stok" id="minimal_stok" min="0"
                                    ...
                                    value="{{ old('minimal_stok', $pengaturan->minimal_stok ?? 10) }}" placeholder="10">
                            ...
                            <small class="text-muted">
                                ...
                                jumlah ini akan dianggap sebagai stok minimal.
                            </small>
